...
if (strlen(get_dex_str("login", $_POST)) == 0 ||
	strlen(get_dex_str("oldpw", $_POST)) == 0 ||
	strlen(get_dex_str("newpw", $_POST)) == 0)
{
	echo "ERROR\n";
	exit(0);
}
...
if ($users[$_POST["login"]] != hash($hash_alg, $_POST["oldpw"]))
{
	echo "ERROR\n";
	exit(0);
}

$users[$_POST["login"]] = hash($hash_alg, $_POST["newpw"]);
