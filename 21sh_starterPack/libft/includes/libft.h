...
# define LDEX(t_list_cell)	LCONT(t_list_cell, t_dict*)
...
t_list			*dict_new(void *key, void *value);
void			**dict_lgetval(t_list *ldict,
					int (*cmp)(void*, void*), void *key);
void			*dict_agetval(const t_dict *dict_arry,
					int (*cmp)(void*, void*), void *key);
...
void			ft_print_mem(void *ptr, size_t size, int base);
