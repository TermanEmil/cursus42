...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/22 18:59:34 by eterman           #+#    #+#             */
/*   Updated: 2017/06/22 19:02:12 by eterman          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Errors (must be updated with ft_errors)
*/
...
/*
** Commands
** All commands written by us must be run in a separate thread, like the
** other commands.
*/
